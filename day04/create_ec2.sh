...
1. Connecting Shell Script to AWS via AWS CLI
2. Creating an EC2 Instance Using AWS CLI
3. Checking EC2 Instance State
...
main() {
	...
	SUBNET_ID="subnet-06d67c19057d74500"
	SECURITY_GROUP_IDS="sg-06707a3cc8aca24d2"  # Add your security group IDs separated by space
